...
- [dRPC Agent Skills](https://github.com/drpcorg/drpc-agent-skills) - Blockchain RPC skills for Windsurf. Query balances, read contracts, check gas across EVM chains and Solana via DRPC.
